...
![图5-5 发射信号（TX）时域波形与频谱分析](../../output/figures/第5章_图5-5_发射信号时频域.png)
...
![图5-6 接收信号（RX）时域波形与频谱分析](../../output/figures/第5章_图5-6_接收信号时频域.png)
...
![图5-7 混频中频信号（IF）时域波形与频谱分析](../../output/figures/第5章_图5-7_混频信号时频域.png)
...
![图5-8 目标色散介质（5阶切比雪夫带通滤波器）的$|S_{21}|$幅度响应](../../output/figures/第5章_图5-8_S21幅度响应.png)
...
![图5-9 目标色散介质的群时延$\tau_g(f)$理论真值曲线（ADS S参数导出）](../../output/figures/第5章_图5-9_群时延真值.png)
...
![图5-10 经去嵌入与物理约束清洗后的群时延特征散点与ADS理论真值对比](../../output/figures/第5章_图5-10_散点与真值对比.png)
...
![图5-11 MCMC马尔科夫链游走轨迹与一维边缘后验分布](../../output/figures/第5章_图5-11_MCMC轨迹与后验.png)
...
![图5-12 三参数联合后验分布与参数耦合分析（Corner Plot）](../../output/figures/第5章_图5-12_Corner_Plot.png)
...
![图5-13 贝叶斯极大后验群时延重构与观测散点叠加对比](../../output/figures/第5章_图5-13_后验重构与散点.png)
