...
- [论文大纲](file:///Users/mac/Desktop/lunwx/.agent/workflows/resources/大纲.txt) - 研究框架
- [公式模板](file:///Users/mac/Desktop/lunwx/.agent/workflows/resources/formula-templates.md) - 标准公式

### 代码参考资源
- [thesis-code目录](file:///Users/mac/Desktop/lunwx/.agent/workflows/thesis-code/) - 现有仿真代码
- [代码参考文档](file:///Users/mac/Desktop/lunwx/.agent/workflows/resources/matlab-code-reference.md) - 代码说明
...
```
/Users/mac/Desktop/lunwx/.agent/workflows/research_output/
├── YYYYMMDD_[研究主题]/
│   ├── report.md                    # 技术报告
│   ├── code/
...
**协同使用场景**：
1. 用 `/research-learning` 探索新想法 → 产出代码和数据
2. 用 `/thesis-writing` 将研究成果写成论文章节
3. 用 `/expert-review` 评审论文质量
4. 用 `/finalize` 定稿并生成配图
