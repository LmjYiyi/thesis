...
params.cst.project_name = 'SRR_TimeDomain';
...
if CST_CONNECTED
    ...
    try
        ...
        vba_srr_out = [...
            ...
            sprintf('  .Xrange "%.4f", "%.4f"', -params.srr.L_out/2, params.srr.L_out/2) newline ...
            sprintf('  .Yrange "%.4f", "%.4f"', y_bottom, y_bottom + 0.035) newline ...
            sprintf('  .Zrange "%.4f", "%.4f"', params.srr.z_pos - params.srr.L_out/2, params.srr.z_pos + params.srr.L_out/2) newline ...
            '  .Create' newline ...
            'End With'];
        invoke(mws, 'AddToHistory', 'create SRR outer', vba_srr_out);
        ...
        vba_srr_in = [...
            ...
            '  .Component "SRR"' newline ...
            '  .Material "Vacuum"' newline ...
            sprintf('  .Xrange "%.4f", "%.4f"', -params.srr.L_in/2, params.srr.L_in/2) newline ...
            sprintf('  .Yrange "%.4f", "%.4f"', y_bottom, y_bottom + 0.035) newline ...
            sprintf('  .Zrange "%.4f", "%.4f"', params.srr.z_pos - params.srr.L_in/2, params.srr.z_pos + params.srr.L_in/2) newline ...
            '  .Create' newline ...
            'End With'];
        invoke(mws, 'AddToHistory', 'create SRR inner', vba_srr_in);
        
        % 布尔减法
        invoke(mws, 'AddToHistory', 'boolean subtract', ...
            'Solid.Subtract "SRR:SRR_Outer", "SRR:SRR_Inner"');
        fprintf('  ✓ SRR结构创建完成\n');
